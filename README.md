...
# 7_лабораторная_работа
- [x] Наличие скрытой ссылки «Перейти к контенту»
- [x] Семантическая HTML-структура и правильные label
- [x] Содержательные alt для изображений
- [x] Контрастность ≥ 4.5:1
- [x] Видимый фокус на интерактивных элементах
- [x] Подключен Normalize.css
- [x] Отсутствие ошибок в W3C Validator
